 ...
 */
export const ThrottleMessage = () => Throttle({ default: { limit: 30, ttl: 60000 } });

/**
 * Oddiy POST/PATCH/DELETE operatsiyalar uchun
 * 20 ta so'rov / 1 daqiqa
 */
export const ThrottleWrite = () => Throttle({ default: { limit: 20, ttl: 60000 } });

/**
 * GET operatsiyalar uchun - ko'proq ruxsat
 * 120 ta so'rov / 1 daqiqa
 */
export const ThrottleRead = () => Throttle({ default: { limit: 120, ttl: 60000 } });
